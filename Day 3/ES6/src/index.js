...
const stu1marks1 = new Marks("Math",89);
const stu1marks2 = new Marks("Chemistry",99);
const stu1marks3 = new Marks("Physics",90);

let markArr1 = [stu1marks1,stu1marks2,stu1marks3];

const stu2marks1 = new Marks("Math",79);
const stu2marks2 = new Marks("Chemistry",45);
const stu2marks3 = new Marks("Physics",87);

let markArr2 = [stu2marks1,stu2marks2,stu2marks3];

const stu3marks1 = new Marks("Math",59);
const stu3marks2 = new Marks("Chemistry",67);
const stu3marks3 = new Marks("Physics",40);
